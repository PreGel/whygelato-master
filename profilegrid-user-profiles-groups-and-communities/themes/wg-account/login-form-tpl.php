...
<!--Form Starts-->
  ...
  <?php wp_nonce_field('pm_login_form'); ?>
            ...
            <div class="pm-login-box-bottom-container pm-dbfl pm-bg pm-border">
                <input type="submit" value="Login" name="login_form_submit" class="pm-difl button large">
  ...
  <p class="text-center">Don't have an account with us? <a href="/pm_registration">Register Here, it's quick and easy!</a></p>
  <?php endif;?>
   </div>
</div>
