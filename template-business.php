<?php
/* Template Name: Business Intro Content */
?>
...
<div class="wg-section">
    ...
    <div class="row">
    	<div class="large-12 columns text-left">
    		<div class="section-lone-copy" data-magellan><p>The idea of starting a new business can be an intimidating concept, but even more so if you don’t have the <a href="#tools">right information or tools.</a> WhyGelato.com is an all-inclusive resource that will act as your guide to opening a successful business in the United States, and help you understand why the <a href="#statistics">gelato business is a good investment</a>.</p>
    			<blockquote>Our consultants are well-versed in the intricate details of the gelato business and what it takes to succeed in the American&nbsp;market.</blockquote>
    		<p>WhyGelato.com will provide the necessary collection of quantitative data that is important to consider when planning ownership and operation of a specialty frozen desserts business. Our consultants are well-versed in the intricate details of the gelato business and what it takes to succeed in the American market. <a href="#tools">We invite you to examine the digital literature we’ve compiled for you in the pages below.</a></p></div>
    	</div>
    </div>
</div>
</div>
...
<!-- Statistics Row -->
<div id="statistics" class="wg-section show-for-large">
	<div class="row">
		<div class="large-4 columns text-center">
			<div class="ready">
				<!--https://codepen.io/talgautb/pen/WboPXy/?editors=110-->
			...
			dy=".4em"
			text-anchor="middle"
			class="text">$4.2B</text>
		</svg>
		<!-- <h2 class="section-title">Industry Produces $4.2B Per Year</h2> -->
	</div>
	

	<!-- <h2 class="section-title">Gelato produces $4.2M per year in the U.S.</h2> -->
</div>
<div class="large-4 columns text-center">

	<div class="ready">
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 184.58 142"><defs>
			<style>.cls-1{opacity:0.18;}.cls-2{fill:#e57200;}.cls-3{fill:#fff;}</style></defs><title>Chart background</title>
			<g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><g class="cls-1"><rect class="cls-2" x="29.31" y="0.5" width="141" height="141"/>
				<path class="cls-3" d="M169.81,1V141h-140V1h140m1-1h-142V142h142V0Z"/></g>

				<polyline class="chart-path" points="0.31 121.5 64.31 71.5 87.31 84.5 184.31 20.5"/></g></g>
				<!-- <text x="50%" y="50%" dy=".4em" text-anchor="middle">Growing at 3.2% annually</text> -->
				<!-- <h2 class="section-title">Growing at 3.2% Annually</h2> -->
			</svg>
	...
	<div class="large-4 columns text-center">
		...
		<!-- <h2 class="section-title">Profit Projections</h2> -->
	</div>
</div>
<div class="row">
	<div class="large-4 columns text-center">
...
<div class="wg-section">
    ...
    <div class="row">
    	<div class="large-12 columns text-left">
    		<div class="section-lone-copy" data-magellan>
    			<h2>Why Gelato?</h2>
    			<p>Have you ever wondered what <strong>happiness</strong> is? If you ask this question to a child, the answer would be simple: <strong>GELATO!</strong></p>
    			<p>Gelato can be the star of your life plan with the grand opening of a gelateria. This is an ethical project that aims to bring your professional goals and desires to fruition through the creation of customizable and artisanal specialty dessert products.</p>
    		</div>
    	</div>
    </div>
      ...
      <div class="testimonial-slide row">
        <div class="small-12 large-9 column">
          <div class="row align-middle testimonial-slide-content">
            ...
            <div class="small-12 medium-12 column testimonial-slide-text">
              <p class="testimonial-slide-quotation">Develop a plan and stick to it. Don’t chase the dream by offering everything under the sun. Figure out what you do the best and do it.</p>
              <div class="testimonial-slide-author-container">
                ...
                <p class="testimonial-slide-author-info">Bob Hoxie<br><i class="subheader">Mangiamo Café, CA</i></p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="testimonial-slide row">
        <div class="small-12 large-9 column">
          <div class="row align-middle testimonial-slide-content">
            ...
            <div class="small-12 medium-12 column testimonial-slide-text">
              <p class="testimonial-slide-quotation">Gelato is still fairly unknown to most people. When they try a sample and you just watch their eyes light up from that “wow” experience, it is a great feeling</p>
              <div class="testimonial-slide-author-container">
                <!-- <div class="small-profile-pic show-for-small-only">
                  <img src="https://placeimg.com/50/50/architecture">
                </div> -->
                <p class="testimonial-slide-author-info">Bruce Koeller<br><i class="subheader">Amore Gelato, CO</i></p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="testimonial-slide row">
        <div class="small-12 large-9 column">
          <div class="row align-middle testimonial-slide-content">
            ...
            <div class="small-12 medium-12 column testimonial-slide-text">
              <p class="testimonial-slide-quotation">Passion for gelato, beautiful, fresh, creative gelato flavors, imaginative mixes that are delicious and innovative, the best ingredients and an impeccable staff. That is the difference between passion and mediocrity—the detail and the high standards, which are the essence of great gelato.</p>
              <div class="testimonial-slide-author-container">
                <!-- <div class="small-profile-pic show-for-small-only">
                  <img src="https://placeimg.com/50/50/animals">
                </div> -->
                <p class="testimonial-slide-author-info">Doc and Katrina Ryan<br><i class="subheader">Sugarland, NC</i></p>
              </div>
            </div>
          </div>
        </div>
...
<!-- slider close -->
   ...
   <!--  end testionial slider -->


     <div class="row">
    	<div class="large-12 columns text-left">
    		<div class="section-lone-copy" data-magellan>
    			<h2>Yes, but how do I actually open a gelateria?</h2>
    			<p>There are many aspects to consider when moving forward with the decision to start a gelato business.  In this case, a reliable resource offering an <a href="#tools">abundance of information and support</a> such as WhyGelato.com is best practice.</p>
    			<h2>Why choose WhyGelato.com?</h2>
    			<p>WhyGelato.com is an ideal resource for information and guidance, <a href="#tools">offering you 365° of unique service</a> during your quest to open a gelateria in the United States. Here you will find in-depth answers to your questions, and the kind of support that is necessary to ensure your success from the earliest planning stages to the opening of your gelateria. Through WhyGelato.com, you will obtain the continuous assistance you need to build your dream without the constraints of franchise fees or royalties.</p>
    			<blockquote>Through WhyGelato.com, you will obtain the continuous assistance you need to build your dream without the constraints of franchise fees or royalties.</blockquote>
    			<p>You will be at the heart of your business in an active and proactive way, not passively accepting the commands that impose on a franchise brand. As an entrepreneur creating and developing your establishment from its foundation, you, along with WhyGelato.com can begin the process of building a successful business.</p>
    			<p>Opening a gelateria requires a very high level of attention and professionalism to avoid making mistakes that could considerably affect your initial economic investment and create a business plan that would prove difficult to make ends meet. Therefore, it is extremely important to seek expert advice on all choices that will arise.</p>
    			<p>Now that you have decided to make this big step toward entrepreneurship, WhyGelato.com can assist you with the following services:</p>		
    		</div>
    	</div>
    </div>
</div>
						...
						<div class="wrapper" data-equalizer-watch>
							<a href="business-plan">
								...
								<svg id="Layer_4" data-name="Layer 4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 84.33 100">
									...
									<div class="mo-link">
									<h3 class="text-center">Business&nbsp;Plan / Investments Evaluation</h3>
									<p>Learn More</p>
								    </div>
								</a>
							</div>
